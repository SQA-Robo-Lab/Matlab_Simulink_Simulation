...
Self_Transition = Stateflow.Transition(DriveControl_main);
Self_Transition.Destination = DriveControl_main;
...
Transition_.LabelString = Transition_.LabelString + "[driveControl_recv" + '==' + "4]";



Transition_.LabelString = Transition_.LabelString +  "{ accelerate }";
...
Transition_.LabelString = "";
Transition_.LabelString = Transition_.LabelString + "[frontDistance<distanceLimit]";



Transition_.LabelString = Transition_.LabelString +  "{ slowDown }";


Transition_.LabelString = Transition_.LabelString + "{driveControl_send" + '==' + "1}";
...
Transition_.Source = WaitForPermission;
Transition_.LabelString = "";
Transition_.LabelString = Transition_.LabelString + "[driveControl_recv" + '==' + "2]";
...
Transition_.LabelString = Transition_.LabelString + "{driveControl_send" + '==' + "7}";
...
Transition_.LabelString = Transition_.LabelString +  "{ changeLane }";
...
Transition_.LabelString = "";
Transition_.LabelString = Transition_.LabelString + "[rearDistance>2*distanceLimit]";



Transition_.LabelString = Transition_.LabelString +  "{ changeLaneBack }";
...
Transition_.LabelString = "";
Transition_.LabelString = Transition_.LabelString + "[rearDistance<laneDistance]";
